  ...
  module.exports = Datepicker = (function(superClass) {
    ...
    Datepicker.prototype.create = function(model, dom) {
      ...
      return dom.on("mousedown", (function(_this) {
        return function(e) {
          if (!(_this.parent.contains(e.target) || !model.get("show"))) {
    ...
    Datepicker.prototype.select = function(selectedDate) {
      return this.emitDelayable("preselect", (function(_this) {
        return function() {
          var currentDate, currentMonth, date, previousDate, selectedMonth;
          previousDate = _this.model.get("active");
          date = moment(selectedDate.fullDate);
          selectedMonth = date.month();
          currentDate = moment(_this.getCurrentDate());
          currentMonth = currentDate.month();
          if (selectedMonth !== currentMonth) {
            _this.gotoMonthView(date);
          }
          _this.model.set("active", selectedDate.fullDate);
          _this.model.set("show", false);
          return _this.emit("select", previousDate);
        };
      })(this));
    };
